...
function getPage(id, pageId) {
    return __awaiter(this, void 0, void 0, function* () {
        let page = yield apiClient.get(`/v1/notebooks/${id}/pages/${pageId}`);
        return page.data;
    });
}
...
function updatePageContent(id, page) {
    return __awaiter(this, void 0, void 0, function* () {
        let updatedPage = yield apiClient.put(`/v1/notebooks/${id}/pages/${page.id}/content`, page);
        return updatedPage.data;
    });
}
