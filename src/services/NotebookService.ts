...
async function updatePageContent(id: number, page: NotebookPage): Promise<NotebookPage> {
    let updatedPage = await apiClient.put(`/v1/notebooks/${id}/pages/${page.id}/content`, page);
